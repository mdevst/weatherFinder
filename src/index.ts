...
export default {
  ...
  * @example weatherfinder.find("new york", "ny, united states")
  * @returns {convertedData}
  * @async
  */
  find: async (place: string, area: string, options: weatherFinderOptions = { allData: false, icons: null }): Promise<convertedData> => {
    try{
